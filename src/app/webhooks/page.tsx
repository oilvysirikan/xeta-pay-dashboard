        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-4">
              {[
                { id: "WH001", provider: "Omise", type: "payment.succeeded", status: "processed", time: "2 min ago" },
                { id: "WH002", provider: "Stripe", type: "payment.failed", status: "processed", time: "5 min ago" },
                { id: "WH003", provider: "LianLian", type: "payment.succeeded", status: "processed", time: "10 min ago" },
                { id: "WH004", provider: "Omise", type: "payment.pending", status: "pending", time: "15 min ago" },
                { id: "WH005", provider: "Stripe", type: "payment.succeeded", status: "processed", time: "20 min ago" },
              ].map((event) => (
